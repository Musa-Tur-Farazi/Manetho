          ...
          <div className="mb-8 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              {verifying
                ...
                : "Join Manetho to enhance your learning experience"}
            </p>
          </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="block w-full bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg text-gray-900 dark:text-white focus:ring-2 focus:ring-cyan-500 dark:focus:ring-cyan-400 focus:border-transparent transition-all duration-200 shadow-sm p-2.5"
                    />
                  </div>
                </div>
